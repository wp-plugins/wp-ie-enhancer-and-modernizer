 ...
 * UPDATED [IE9.js](http://code.google.com/p/ie7-js/) Code v2.1(beta4) and PNG Sintax
 * UPDATED [ie7-squish.js](http://code.google.com/p/ie7-js/source/detail?r=19) Code v2.1(beta4)

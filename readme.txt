...
== Upgrade Notice ==
= 2014.0228.2129 =
* Requested Update [STABLE] Support for non IE and Mobile Browsers! Previous Release: Update HTML5 Shiv Print to v3.7.0 - Add Support for IE10 and IE11 - Removed Support for CSS3-PIE - Rules: Recalc HTML/CSS issues, transparent PNG, shiv (X)HTML5 elements, applies basic (X)HTML5 styling for elements, allowing (X)HTML5 elements to be styled and contain children while being printed, render latest version, squish IE bugs, prevent framekiller, clickjacking, XSS

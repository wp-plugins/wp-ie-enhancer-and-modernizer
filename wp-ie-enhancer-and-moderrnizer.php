...
function wpieeam_log(){echo"<!--Plugin WP IE Enhancer and Modernizer 2011.0427.0133 Active-->";}add_action('wp_head','wpieeam_log');add_action('wp_footer','wpieeam_log')?><?php
